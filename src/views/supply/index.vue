  ...
  <div class="road">
   ...
   <div class="layui-container">
           <div class="supply_box">
              <div class="supply_title">最新需求</div>         
              <div class="handle_btn1" v-on:click="showPopup(1)">发布需求</div>
            </div>
         ...
         <router-link :to="{path:'/supplylist',query: {type:1}}"><div class="to_list">更多需求</div></router-link>
         <div class="supply_box">
          <div class="supply_title">最新供求</div>         
          <div class="handle_btn1" v-on:click="showPopup(2)">发布供求</div>
        </div>
        <div class="supply_item" v-for="item in piclist1">
          <div class="go_detail"><i class="layui-icon layui-icon-reply-fill"></i></div>
          <div class="user_info">
            <span class="user_img"><img src="../../assets/defaultuser.jpg"></span>
            <div class="user_text">
        ...
        <router-link :to="{path:'/supplylist',query: {type:2}}"><div class="to_list">更多供求</div></router-link>
