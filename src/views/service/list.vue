<template>
  <div class="road">
   ...
   <div class="layui-container">
          ...
          <router-link :to="{path:'/communitydetail',query: {id: item.id}}"><div class="go_detail">评论</div></router-link>
          <div class="user_info">
    ...
    <div class="popup" v-show="uploadershow">
           <div class="popup-content">
            ...
            <form class="pure-form pure-form-stacked">
             <div class="pure-g">
              <div class="pure-u-1">
               <input placeholder="标题" maxlength="50" class="hd_title" v-model="title"></input>
              </div>
              <div class="pure-u-1">
               <textarea cols="30" rows="8" placeholder="内容" maxlength="1500" required="required" class="hd_content" v-model="content"></textarea>
              </div> 
              <div class="pure-u-1">
    ...
    createPics:function(){
      ...
      if(_userid==0){
        ...
        this.$router.push({"path":url});    
              ...
              var that=this;
              this.$http.baseAction("ServicePicUpload",params)
                .then(response => {
