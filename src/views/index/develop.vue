                    ...
                    <el-form ref="infoForm" :model="infoForm" :rules="rules" label-width="50px">
                        <el-form-item label="标题" prop="a_title">
                          ...
                          <el-form-item label="名言" prop="a_title">
                            <el-select  v-model="goldword" placeholder="a_type" @change="handleword($event)">
                                <el-option
...
Vue.use(Element)
  ...
  export default{
    ...
    onSubmit:function(event){
        ...
        var addcontent='<p><span style="color: rgb(230, 0, 0);">更多特产投稿或销售，请添加小编微信(lcs13554219576)</span></p><p><span style="color: rgb(230, 0, 0);">﻿</span><img src="https://www.hdhome.net/source/image/wx/me.jpg"></p>'
        var params={
          ...
          content:this.content+addcontent,
