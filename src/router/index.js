...
export default new Router({
  routes: [
    ...
    { 
     path: '/edit',
     name: 'edit',
     component: resolve=>(require(["@/views/index/edit"],resolve))
    ...
    { 
     path: '/serviceproduct',
     name: 'ServiceProduct',
     component: resolve=>(require(["@/views/service/product"],resolve))
    ...
    { 
     ...
     component: resolve=>(require(["@/views/service/communitydetail"],resolve))
    ...
    { 
     path: '/supplylist',
     name: 'SupplyList',
     component: resolve=>(require(["@/views/supply/list"],resolve))
    },
    { 
     path: '/apply',
     name: 'Supply',
    ...
    { 
     path: '/card',
     name: 'Card',
     component: resolve=>(require(["@/views/card/index"],resolve))
    },
